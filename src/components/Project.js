...
export default function Project({ title, image, link, programs, altDesc, gitHub }) {
    return (
        <figure className="project-container">
            ...
            <div id="project-description">
                ...
                <div className="d-flex">
                    <div className="programs me-2">{programs}</div>
                    <a href={gitHub} target="_blank" rel="noreferrer noopener" className="pb-1" id="gitHub-link">
